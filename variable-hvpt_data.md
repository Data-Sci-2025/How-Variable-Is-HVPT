...
1.  [Retrieved the raw mp3 audio
    files](instructions/raw-data-retrieval-instructions.md),
2.  [Converted them to wav
    files](instructions/audio-conversion-instructions.md),
3.  [Used Praat to annotate, segment, and extract acoustic
    measurements.](instructions/praat-segmentation-instructions.md)
