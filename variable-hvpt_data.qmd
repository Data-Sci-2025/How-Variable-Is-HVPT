...
1. Download the audio files.
    * On the [Nagle et al. (2025) OSF Files page](https://osf.io/mnks9/files), navigate to `1 Materials` > `Training Materials` > `Training Stimuli 6-Talker Group` and click `Download As Zip` in the right-hand corner. 
    * Download the zip file to this directory (repository `How-Variable-Is-HVPT`) and extract the files by double-clicking on the zip file. 
    * Delete the *old* zip file
    * Re-name this folder as `sound-files`. **It is very important that you do this.**
